...
local simpleCircle = function(pos, fill, strikeClr, radius)
  ...
  td:circle(circlePos.x, circlePos.y, ((radius or 6)-strikeWidth)*M.dpi, strikeWidth*M.dpi, fill or fillColor, fill or fillColor, strikeClr or strikeColor, strikeClr or strikeColor)
end
...
local simpleLine = function(pos1, pos2, fill, strikeClr)
  ...
  td:lineRoundEnd(linePos1.x, linePos1.y, linePos2.x, linePos2.y, strikeWidth*M.dpi, strikeWidth*M.dpi, strikeWidth*M.dpi, fill or fillColor, fill or fillColor, strikeClr or strikeColor, strikeClr or strikeColor)
end
...
local drawEdgePointer = function(pos, fill, strikeClr, radius, maxDistance)
  ...
  td:circle(intersectionLocal.x, intersectionLocal.y, circleRadius, 1*M.dpi, clrNavBg, clrNavBg, strikeColor, strikeColor)
  td:triangle(tip.x, tip.y, side1.x, side1.y, side2.x, side2.y, 2*M.dpi, 0, clrNavBg, clrNavBg, clrNavBg, clrNavBg)

  td:circle(intersectionLocal.x, intersectionLocal.y, circleRadius-2*M.dpi, 0, fill or fillColor, fill or fillColor, 0, 0)
  td:triangle(tip.x, tip.y, side1.x, side1.y, side2.x, side2.y, 0, 0, fill or fillColor, fill or fillColor, fill or fillColor, fill or fillColor)
  return true
end
...
M.drawGrid = function()
  ...
  for x = startX, endX, gridSpacing do
    ...
    td:line(x1, y1, x2, y2, 0, 0, 0.5, 0.5, clrGridWhite, clrGridWhite, clrGridWhite, clrGridWhite)
  end
