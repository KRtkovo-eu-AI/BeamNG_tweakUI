...
local function generateGroup(class, mode, modelFilter, configFilter, configTypeFilter, invertedFilters, randomizePaint, smartShuffle) -- generates a group of vehicles for the given class
  ...
  if class == "X" then class = "S" end -- safe fallback
